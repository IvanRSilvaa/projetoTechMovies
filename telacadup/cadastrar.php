...
$plano_usuario = $_POST['plano_usuario'];
$opmes = $_POST['opmes'];



// Validar o campo nome_usuario, acessa o IF quando o campo está vazio 
if (empty($dados['endereco_usuario'])) { // Validar o campo email_usuario, acessa o ELSEIF quando o campo está vazio 
...
elseif (empty($dados['numcart'])) { // Validar o campo email_usuario, acessa o ELSEIF quando o campo está vazio 
  ...
  //  $cad_usuario->bindParam(':opmes', $dados['opmes']);
