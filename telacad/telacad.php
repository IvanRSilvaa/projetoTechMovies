...
<form id="cad-usuario-form"  method ="POST" action="cadastrar.php"> 
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="inputBox">
        <span>Nome: </span>
        <input type="text" name="nome_usuario" id="nome_usuario" placeholder="Digite o nome completo">
                </div>


                <div class="inputBox">
                <span>E-mail: </span>
        <input type="email" name="email_usuario" id="email_usuario" placeholder="Digite o melhor e-mail">
               </div>

                <div class="inputBox">
                    <span>senha:</span>
                    <input type="password" name="senha_usuario" id="senha_usuario" placeholder="Digite uma senha">
                </div>
                ...
                <a class="BotaoVoltar" href="../telaplanos/telaplanos.html" ><img src="back.png" alt=""></a>
            </div>
            ...
            <div class="col">
                ...
                <div class="inputBox">
                        ...
                        <input type="text" name="namecart" id="namecart" placeholder="Maria Vincentina">     
                    </div>
                <br>
                <div class="inputBox">
